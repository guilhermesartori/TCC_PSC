...
public class TestSystemController {
  ...
  public void createSystemAdmin_success() throws Exception {
    ...
    final var mvcResult = mockMvc
        .perform(
            post("/system/admin-user").contentType(MediaType.APPLICATION_JSON).content(content))
        .andReturn();
  ...
  public void setKnetConfiguration_success() throws Exception {
    final var objectMapper = new ObjectMapper();
    final var kNetConfigurationRequest =
        new KNetConfigurationRequest(new HashMap<String, String>());
