...
public class DataSourceConfiguration {
  ...
  private static final String PATH_TO_FILE =
      SEPARATOR + "etc" + SEPARATOR + "psc" + SEPARATOR + "settings.json";
  ...
  private File checkFilePermissions() throws IOException {
    ...
    if (permissions.contains(PosixFilePermission.OTHERS_READ)
      ...
      throw new RuntimeException(String
          .format("Bad file permissions. File %s is others readable or writable.", PATH_TO_FILE));
    if (permissions.contains(PosixFilePermission.GROUP_READ)
        || permissions.contains(PosixFilePermission.GROUP_EXECUTE))
      throw new RuntimeException(String
          .format("Bad file permissions. File %s is group readable or writable.", PATH_TO_FILE));
    return file;
  }
